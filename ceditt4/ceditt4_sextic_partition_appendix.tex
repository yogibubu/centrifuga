...
The mixed products in $Z_1$ are written in cyclic pairs because the
external index $x$ is held fixed inside each term. The full symmetry of
the $\Phi_{abc}$ block is recovered only after summation over the three
cyclic couplings and over $x$.
