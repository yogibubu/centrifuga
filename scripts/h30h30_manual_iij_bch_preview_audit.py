#!/usr/bin/env python3
"""Audit BCH-closed H30H30 iij preview pieces against the VCI sanity targets."""
...
COMPARE_NAMES = (
    ...
    "manual_iij_order2_preview_total",
    "manual_iij_order3_preview_total",
    "manual_iij_bch_closed_preview_total",
)
...
def main() -> None:
    for species, refs in VCI_PAPER.items():
        ...
        for name in COMPARE_NAMES:
            ...
            print(f"  {name:>30} : ||piece||/||delta||={ratio:.6g}  ||delta-piece||/||delta||={resid:.6g}")
        print()
